...
class Tablero:
    ...
    def barco_colocado(self, barco):
        self.barcos_colocados[barco] = True  # Método para guardar en un diccionario.
...
class Barcos:
    ...
    def colocar_barcos(self):
        ...
        while len(self.tablero.barcos_colocados) < len(self.barcos):  # Premisa, si no están todos los barcos colocados seguimos ejecutando.
            ...
            while barco_elegido not in ["0","1","2","3","4"]:  # Control de errores.
                clear_terminal()
                self.tablero.view_tablero()
            ...
            # --------| Atributos del barco |--------
                ...
                fila = int(coord[0])  # Adquirimos del input de coordenadas la fila y columna.
                columna = int(coord[1])
